...
def train_target(args):
	...
	# print(max_iter)
	# interval_iter = max_iter // 150
	pseudo_label_interval_iter = max_iter // args.interval
	iter_num = 0
	...
	while iter_num < max_iter:
		...
		if iter_num % pseudo_label_interval_iter == 0 and args.cls_par > 0:
			netF.eval()
			netB.eval()
			netC.eval()
		...
		if iter_num % 10 == 0:
			print("Adaptation Iter: " + str(iter_num) + " Loss: " + str(classifier_loss.item()))
