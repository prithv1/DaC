...
def train_source(args):
	...
	while iter_num < max_iter:
		...
		if iter_num % 10 == 0:
			log_str = 'Task: {},  Iter:{}; Loss = {:.2f}'.format(args.name_src, iter_num, classifier_loss)
		...
		if iter_num % interval_iter == 0 or iter_num == max_iter:
			...
			torch.save(netF.state_dict(), osp.join(args.output_dir_src, "source_F_it_" + str(iter_num) + ".pt"))
			torch.save(netB.state_dict(), osp.join(args.output_dir_src, "source_B_it_" + str(iter_num) + ".pt"))
			torch.save(netC.state_dict(), osp.join(args.output_dir_src, "source_C_it_" + str(iter_num) + ".pt"))
